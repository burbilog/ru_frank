...
С учетом проблем с оплатой из РФ за серьезные модели, рекомендую использовать DeepSeek, он бесплатный: https://chat.deepseek.com. Так же можно использовать OpenRouter https://openrouter.ai, т.к. они принимают оплату криптовалютой. Через них доступны большинство моделей, включая Sonnet, Gemini, Grok. Недоступна только O3.
...
3. **Обязательная проверка:** Подайте попросите модель перепроверить свою работу:
   - "Перепроверь произношение, указанное в скобках （）, выведи список найденных ошибок вместе с правильным вариантом"
