...
1. Использует LLM для добавления фуриганы (произношения) к японскому тексту
...
**Высокое качество:**
- **Claude Sonnet 4** — отличная точность
- **ChatGPT O3** — высокое качество результатов
- **Gemini 2.5 Pro** — хорошая производительность

**Бюджетные варианты:**
- **GPT-4 Mini** — экономичный вариант с хорошим качеством
- **DeepSeek R1** — приемлемые результаты, но чаще ошибается в произношении
- **Qwen3 235B A22B** — хорошая альтернатива
- **Llama 4 Maverick** — стабильная производительность
