...
2. **Скрипт для LibreOffice:** Автоматически находит текст с фуриганой в скобках и преобразует его в правильное ruby-форматирование (произношение над иероглифами)
