...
1. Предоставляет готовый промпт для LLM, который добавляет фуригану (произношение, написанное над иероглифами) к японскому тексту. Произношение записывается в скобках, после чего текст можно вставить в LibreOffice и там преобразовать уже 
2. Автоматически преобразует текст с фуриганой в скобках в правильное ruby-форматирование LibreOffice
